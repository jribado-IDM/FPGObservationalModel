# Contributing to FPGObservationalModel

Welcome! We are thrilled you are interested in contributing to Observational Model for FPG.
This document will help you get started.

Please see the guidelines below to provide feedback or contribute to the Observational Model
...
to the public under the project's open source [license](https://github.com/EMOD-Hub/FPGObservationalModel/blob/genmoz_metrics/LICENSE.txt).

Review the [documentation](https://github.com/EMOD-Hub/FPGObservationalModel/blob/genmoz_metrics/README.md) before you begin. Additionally, this content is also
...
2. Pull requests:
    ...
    * Bug fixes.
    * Code to resolve
    * Documentation improvements in the [docs](https://github.com/EMOD-Hub/FPGObservationalModel/blob/genmoz_metrics/docs) folder.
...
If you notice unexpected behavior or a limitation in FPGObservationalModel, follow the steps below before
requesting a new feature or reporting a bug.
...
When opening an issue to report a bug, explain the problem and include additional details to help
...
To contribute directly to FPGObservationalModel code, do the following:

1.  Fork and clone the FPGObservationalModel repository.
2.  Install FPGObservationalModel on your machine. See the [project README](https://github.com/EMOD-Hub/FPGObservationalModel/blob/genmoz_metrics/README.md).
